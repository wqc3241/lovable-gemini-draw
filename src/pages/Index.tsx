            ...
            {[
              {
                ...
                features: ["15 credits/month (~60 images)", "Nano Banana model (0.25 cr)", "Up to 5 images per batch", "Watermarked images", "7-day history"],
              ...
              },
              {
                ...
                features: ["150 credits/month (~600 images)", "All 3 AI models (0.25–0.75 cr)", "Up to 9 images per batch", "Watermarked images", "14-day history"],
                limitations: [],
              ...
              },
              {
                ...
                features: ["500 credits/month (~2,000 images)", "All 3 AI models (0.25–0.75 cr)", "Up to 9 images per batch", "Watermarked images", "Unlimited history", "Priority queue"],
                limitations: [],
                popular: false, accent: false,
              },
            ].map((plan) => {
